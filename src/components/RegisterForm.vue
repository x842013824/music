<template>
  <div
    v-if="reg_show_alert"
    class="p-4 mb-4 rounded font-bold text-center text-white"
  ...
  methods: {
    ...
    async register(values) {
      ...
      try {
        ...
        this.reg_alert_msg = 'Success! Yout account has been created'
      } catch (error) {
        this.reg_in_submission = false
        this.reg_alert_varient = 'bg-red-500'
        this.reg_alert_msg = 'An unexcepted error occured. Please try again later'
      }
    }
  }
})
